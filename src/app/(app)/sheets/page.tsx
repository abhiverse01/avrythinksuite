...
import { Table, Plus, LayoutGrid, List } from 'lucide-react';
...
export default function SheetsPage() {
  ...
  const files = useMemo(() => {
    let result = recentFiles.filter((f: FileItem) => f.type === 'sheet');
    ...
    >
      ...
      <div className="flex items-center justify-between gap-4 mb-6">
        <div>
          ...
          <p className="mt-1 text-sm text-[var(--color-text-secondary)]">
            Organize data with powerful spreadsheets
          </p>
        </div>
      ...
      {isLoading ? (
        ...
        <EmptyState
          ...
          description="Create your first spreadsheet to crunch numbers, track data, and visualize trends."
