...
import { Paintbrush, Plus, LayoutGrid, List } from 'lucide-react';
...
export default function CanvasPage() {
  ...
  const files = useMemo(() => {
    let result = recentFiles.filter((f: FileItem) => f.type === 'canvas');
    ...
    >
      ...
      <div className="flex items-center justify-between gap-4 mb-6">
        <div>
          ...
          <p className="mt-1 text-sm text-[var(--color-text-secondary)]">
            Brainstorm and design with an infinite creative workspace
          </p>
        </div>
      ...
      {isLoading ? (
        ...
        <EmptyState
          ...
          description="Create your first canvas to brainstorm ideas, wireframe designs, and collaborate visually."
